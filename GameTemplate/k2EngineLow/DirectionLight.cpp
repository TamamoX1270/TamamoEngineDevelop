...
namespace nsK2EngineLow {
	...
	DirectionLight::DirectionLight()
	{
		...
		//視点の位置を設定する。
		m_ambientLig.eyePos = (Vector3{ 0.0f, 0.0f, 1.0f });//g_camera3D->GetPosition();

		// 環境光
		m_ambientLig.ambientLight.x = 0.3f;
		m_ambientLig.ambientLight.y = 0.3f;
		m_ambientLig.ambientLight.z = 0.3f;
		...
		m_directionLig.ligColor.x = 0.5f;
		m_directionLig.ligColor.y = 0.5f;
		m_directionLig.ligColor.z = 0.5f;
